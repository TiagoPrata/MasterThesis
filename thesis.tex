...
% \include{./2_content/controlePreditivo}	% TODO Reinserir quando capitulo estiver pronto
...
\include{./2_content/metodos}

\include{./2_content/procedimentos}

% PARTE RESULTADOS E DISCUSSÃO
% \part{Resultados e discussão}		% TODO Incluir novamente esta parte para a entrega final
