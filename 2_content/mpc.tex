...
\lstinputlisting[	
    ...
    \begin{center}
        \makebox[\width]{Fonte: Autor, adaptado de \citeonline{Haugen2018}}
    \end{center}
% TODO: (Brincalepe): O código da página 58 também pode ser deslocado para o Apêndice. Seria interessante descrevê-lo no corpo de texto através de um diagrama.