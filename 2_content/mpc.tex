...
décadas \cite{Camacho2007} e segundo \citeonline{Rossiter2003} uma das principais diferenças entre o
...
das saídas e das atuais variáveis medidas e as entradas atuais e futuras. % TODO: Conferir traducao deste pedaco. Rossiter pag 2
...
\citeonline{Rossiter2003} também salienta alguns outros parametros e características que são importantes
importantes para a técnica:
...
\begin{itemize}
    ...
    \item O intervalo de tempo futuro, no qual o \acrshort{mpc} fará o cálculo das predições de controle
            (também conhecido como \textbf{horizonte retrocendente} (\textit{Recending Horizon})) deve
    ...
    \item Outra características extremamente importante do \acrshort{mpc} é sua capacidade intrínseca de
