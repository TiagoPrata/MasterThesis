...
na \cref{fig:tclabsp-model-IOs}. O código-fonte de tal \textit{script} pode ser visto no
\cref{sec:tclabsp-models-creation} e os modelos criados a partir dele são descritos na 
\cref{tab:tclabsp-models-description}.
...
\begin{table}[h]
	...
	\begin{tabular}{ll} \toprule
		...
		Box-Jenkins             	                                    & $1.280$               \\
		\acrshort{arx} não-linear (NLARX)                               & $26.244$              \\ \bottomrule
	\end{tabular}
	\caption*{Fonte: Autor}
\end{table}
...
\cref{fig:tclabsp-models-tf-compare,fig:tclabsp-models-tf-resid}.
