...
% TODO: Retirar este parágrafo, caso o apêndice com documentações seja removido.
...
% TODO: (Brincalepe) Destacar alguma parte importante do código lst:mhe_example, movido pro apêndice,
...
\begin{figure}[h]
	...
	\makebox[\width]{Fonte: Autor, adaptado de \citeonline{Haugen2018}}
\end{figure}
% TODO: (Brincalepe) Interpretar imagem. Adicione comentários aos resultados da Figura 10.